...
static const char *sleeves_name[] = {
  "Sleeves",
  "Sleeves",
  "Sleeves",
  "Sleeves",
...
void create_armor(const char *xname, const char *textname[], const char *xdesc[], const char *descname, const char *xmaterial, int costbase, int armorbase, const char *placement, int quality, int spritebase, double mod)
{
  int n;
