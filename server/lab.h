...
struct lab_ppd {
  ...
  unsigned char graveversion;   // just if we change something, we'll increase
                                // the inside version number and rearrange the
                                // graves
  ...
  unsigned char
      guard_talkstep;  // conversation is at this point (used by guard and door)
  char align_dummy1[2];
