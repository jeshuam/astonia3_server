...
void gwendylon_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct gwendylon_driver_data*)set_data(cn, DRD_GWENDYLONDRIVER, sizeof(struct gwendylon_driver_data));
  if (!dat) return;	// oops...
  ...
  for (msg = ch[cn].msg; msg; msg = next) {
    ...
    if (msg->type == NT_CHAR) {
      ...
      ppd = (struct area1_ppd*)set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
    ...
    if (msg->type == NT_TEXT) {
      ...
      case 2:		ppd = (struct area1_ppd*)set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
...
void yoakin_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct yoakin_driver_data*)set_data(cn, DRD_YOAKINDRIVER, sizeof(struct yoakin_driver_data));
  if (!dat) return;	// oops...
...
void terion_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct terion_driver_data*)set_data(cn, DRD_TERIONDRIVER, sizeof(struct terion_driver_data));
  if (!dat) return;	// oops...
...
void james_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct james_driver_data*)set_data(cn, DRD_JAMESDRIVER, sizeof(struct james_driver_data));
  if (!dat) return;	// oops...
...
void nook_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct nook_driver_data*)set_data(cn, DRD_NOOKDRIVER, sizeof(struct nook_driver_data));
  if (!dat) return;	// oops...
...
void lydia_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct lydia_driver_data*)set_data(cn, DRD_LYDIADRIVER, sizeof(struct lydia_driver_data));
  if (!dat) return;	// oops...
...
void balltrap_skelly_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct balltrap_skelly_driver_data*)set_data(cn, DRD_BALLTRAPSKELLY, sizeof(struct balltrap_skelly_driver_data));
  if (!dat) return;	// oops...
...
void robber_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct robber_driver_data*)set_data(cn, DRD_ROBBERDRIVER, sizeof(struct robber_driver_data));
  if (!dat) return;	// oops...
...
void sanoa_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct sanoa_driver_data*)set_data(cn, DRD_SANOADRIVER, sizeof(struct sanoa_driver_data));
  if (!dat) return;	// oops...
...
void reskin_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct reskin_driver_data*)set_data(cn, DRD_RESKINDRIVER, sizeof(struct reskin_driver_data));
  if (!dat) return;	// oops...
...
void asturin_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct asturin_driver_data*)set_data(cn, DRD_ASTURINDRIVER, sizeof(struct asturin_driver_data));
  if (!dat) return;	// oops...
...
void asturin_dead(int cn, int co)
{
  ...
  if ((ppd = (struct area1_ppd*)set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd)))) {
    ppd->asturin_state = 4;
...
void guiwynn_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct guiwynn_driver_data*)set_data(cn, DRD_GUIWYNNDRIVER, sizeof(struct guiwynn_driver_data));
  if (!dat) return;	// oops...
...
void logain_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct logain_driver_data*)set_data(cn, DRD_LOGAINDRIVER, sizeof(struct logain_driver_data));
  if (!dat) return;	// oops...
