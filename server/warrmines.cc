...
void dwarfchief_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct dwarfchief_data*)set_data(cn, DRD_DWARFCHIEFDRIVER, sizeof(struct dwarfchief_data));
  if (!dat) return; // oops...
...
void dwarfshaman_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct dwarfshaman_data*)set_data(cn, DRD_DWARFSHAMANDRIVER, sizeof(struct dwarfshaman_data));
  if (!dat) return; // oops...
...
void dwarfsmith_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct dwarfsmith_data*)set_data(cn, DRD_DWARFSMITHDRIVER, sizeof(struct dwarfsmith_data));
  if (!dat) return; // oops...
...
void lostdwarf_driver(int cn, int ret, int lastact)
{
  ...
  dat = (struct lostdwarf_data*)set_data(cn, DRD_LOSTDWARFDRIVER, sizeof(struct lostdwarf_data));
  if (!dat) return; // oops...
...
void pick_berry(int in, int cn)
{
  ...
  ppd = (struct flower_ppd*)set_data(cn, DRD_FLOWER_PPD, sizeof(struct flower_ppd));
  if (!ppd) return; // oops...
