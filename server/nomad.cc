...
struct qa qa[] = {
    ...
    {{"llakal", "sla", NULL},
     "Llakal Sla is a game played with three dice. The opponents agree on a "
     "bet, and the one throwing the higher number wins. If thou wishest to "
     "play, say: 'bet <amount>', where amount is in ounces of salt.",
     0},
    {{"repeat", NULL}, NULL, 2},
    ...
    if ((in = ch[cn].item[n]) && it[in].ID == IID_AREA19_SALT) {
      if (*(unsigned int *)(it[in].drdata) <= val) {
        ...
        if (ch[cn].flags & CF_PLAYER)
          dlog(cn, in, "dropped because player lost nomad game");
        remove_item_char(in);
        destroy_item(in);
      } else {
...
int nomad_1(int cn, int co, struct nomad_ppd *ppd, int nr) {
  ...
  switch (ppd->nomad_state[nr]) {
    ...
    case 1:
      say(cn,
          "Welcome to the plains of the Vana Laka. Thou wouldst best learn "
          "about our customs, before thou venturest further north, %s.",
          ch[co].name);
      ppd->nomad_state[nr]++;
      return 1;
    case 2:
      say(cn,
          "We value not what the city-folks call money. We have no use for it. "
          "Most of our trades work in skins or salt for both are important for "
          "our survival.");
      ppd->nomad_state[nr]++;
      return 1;
    case 3:
      say(cn,
          "We are fierce warriors, and our shaman's magic is deadly. Each "
          "tribe of the Vana Laka is loyal only to its members, and, to a "
          "certain degree, to the members of the other tribes.");
      ppd->nomad_state[nr]++;
      return 1;
    case 4:
      say(cn,
          "Those who are tribe-less will have a hard time finding trade "
          "partners, or opponents for °c4Llakal Sla°c0.");
      ppd->nomad_state[nr]++;
      return 1;
    case 5:
      say(cn,
          "If thou wishest to earn membership in my tribe, the Vana Kiru, thou "
          "must prove thy worth to us. Collect 100 ounces of salt and hand "
          "them to me, and I will welcome thee to the Vana Kiru.");
      ppd->nomad_state[nr]++;
      return 1;
    case 6:
      say(cn,
          "I will also trade any wolf skins thou might find for salt, in spite "
          "of thee being tribe-less. Thou canst find wolves to the north-east, "
          "or thou canst go north-west, to my tribe.");
      ppd->nomad_state[nr]++;
      return 1;
    case 7:
...
int nomad_2(int cn, int co, struct nomad_ppd *ppd, int nr) {
  ...
  switch (ppd->nomad_state[nr]) {
    ...
    case 1:
      say(cn,
          "I have a nice collection of dice. I'd sell thee a set of °c4cheap "
          "dice°c0 for 200 ounces of salt, or a set of °c4mediocre dice°c0 for "
          "500 ounces, or a set of °c4 good dice°c0 for 1200 ounces.");
      ppd->nomad_state[nr]++;
      return 1;
    case 2:
      return 0;  // finished
...
int nomad_4(int cn, int co, struct nomad_ppd *ppd, int nr) {
  ...
  switch (ppd->nomad_state[nr]) {
    case 0:
      say(cn, "Welcome to the monastery of Kir Laka, %s. I am %s.", ch[co].name,
          ch[cn].name);
      questlog_open(co, 33);
      ppd->nomad_state[nr]++;
      return 1;
    case 1:
      say(cn,
          ...
          "mountains have never been friendly, but only a short while ago all "
          "one had to fear was the cold, or losing one's way. Now one has to "
          "fear being eaten alive by Harpies. Welcome again, %s. It is good to "
          "see that there are %s brave enough to visit us.",
          ch[co].name, (ch[co].flags & CF_MALE) ? "men" : "women");
      ppd->nomad_state[nr]++;
      return 1;
    case 2:
      say(cn,
          "Unfortunately, the Harpies are not our only problem. Brother "
          "Sarkilar has left the monastery with a few of the younger brothers. "
          "We haven't heard from him since he left, and I am worried. Neither "
          "the nomads nor the valkyries have seen him, so he must still be in "
          "this mountain. If thou couldst find out what happened to him?");
      ppd->nomad_state[nr]++;
      return 1;
    case 3:
    ...
    case 4:
      say(cn,
          "Oh, Sarkilar! What hast thou done? How couldst thou fall for the "
          "silver tongue of evil? I thank thee, %s, even though thine news is "
          "sad indeed.",
          ch[co].name);
      ppd->nomad_state[nr]++;
      return 1;
...
int nomad_5(int cn, int co, struct nomad_ppd *ppd, int nr) {
  ...
  switch (ppd->nomad_state[nr]) {
    case 0:
      say(cn, "Welcome to the monastery of Kir Laka, %s. I am %s, the teacher.",
    ...
    case 1:
      say(cn,
          "We of the Kir believe in life, and in the mastery of life. The "
          "concept of god-hood is alien to us; and while we value Ishtar's "
          "fight against the demonic hordes, we do not believe he is a god. "
          "But enough of Ishtar.");
      ppd->nomad_state[nr]++;
      return 1;
    case 2:
      say(cn,
          "I can teach thee about life, in exchange for a golden statue of "
          "Kir. One of the nomads sells them.");
      ppd->nomad_state[nr]++;
      return 1;
    case 3:
    ...
    case 4:
      say(cn,
          "If thou ever needst to regain lost experiences, I can help thee in "
          "the process. I won't be able to bring it all back, but most of it. "
          "Do not forget to bring a golden Kir statue...");
      ppd->nomad_state[nr]++;
      return 1;
    case 5:
      return 0;  // waiting for statue
...
int nomad_6(int cn, int co, struct nomad_ppd *ppd, int nr) {
  ...
  switch (ppd->nomad_state[nr]) {
    ...
    case 1:
      say(cn,
          "Wouldst thou like to buy a °c4golden statue°c0? I shall give it to "
          "thee for only 10000 ounces of salt!");
      ppd->nomad_state[nr]++;
      return 1;
    case 2:
      return 0;  // finished
...
int nomad_1_give(int cn, int co, int in, struct nomad_ppd *ppd, int nr) {
  ...
  if (it[in].ID == IID_AREA19_SALT) {
    ...
    if (*(unsigned int *)(it[in].drdata) < 100) {
      say(cn,
          "This is not enough. Thou needst give me 100 ounces of salt for thy "
          "membership.");
      return 0;
    }
    if (*(unsigned int *)(it[in].drdata) > 100) {
      say(cn,
          "This is most generous, but I wilt not accept more than 100 ounces "
          "for thy membership.");
      return 0;
    }
  ...
  if (it[in].ID == IID_AREA19_WOLFSSKIN || it[in].ID == IID_AREA19_WOLFSSKIN2) {
    cnt = *(unsigned int *)(it[in].drdata);
    if (it[in].ID == IID_AREA19_WOLFSSKIN)
      val = cnt * 5;
    else
      val = cnt * 20;
...
int nomad_5_give(int cn, int co, int in, struct nomad_ppd *ppd, int nr) {
  ...
  if (it[in].ID == IID_AREA19_KIR) {
    if (ppd->nomad_state[nr] > 3) {
      ...
      say(cn,
          "There, some of the memories are back. I can work with thee further, "
          "if thou bringst me another of these statues.");
      ...
      say(cn, "Isn't it beautiful? Thank thee, %s. Now, let me teach thee...",
          ch[co].name);
      questlog_done(co, 34);
      ppd->nomad_state[nr] = 4;
    }
...
void nomad_bet(int cn, struct nomad_data *dat, int co, int val,
               struct nomad_ppd *ppd, int nr) {
  int d1, d2, d3;
  ...
  if (ppd->nomad_win[nr] < -dat->max_loss) {
    say(cn,
        "I won't play with thee anymore, %s. Thou art too lucky for my taste.",
        ch[co].name);
    return;
  }
  ...
  if (val > count_salt(co)) {
    say(cn, "Thou dost not have %d ounces of salt to play with, %s.", val,
        ch[co].name);
    return;
  }
  ...
  log_area(ch[cn].x, ch[cn].y, LOG_INFO, cn, 8,
           "%s rolled %d, %d and %d for a total of %d.", ch[cn].name, d1, d2,
           d3, d1 + d2 + d3);
...
void nomad_roll(int cn, struct nomad_data *dat, int co, int val,
                struct nomad_ppd *ppd, int nr) {
  int in2;
  ...
  if (dat->bet >= ppd->open_bet)
    ppd->open_bet = 0;
  else
    ppd->open_bet -= dat->bet;

  if (dat->bet > count_salt(co)) {
    say(cn,
        "Thou dost not have %d ounces of salt to play with, %s. The game's "
        "cancelled.",
        val, ch[co].name);
    return;
  }
...
void nomad(int cn, int ret, int lastact) {
  ...
  dat = (struct nomad_data *)set_data(cn, DRD_NOMADDRIVER,
                                      sizeof(struct nomad_data));
  if (!dat) return;  // oops...
  ...
  for (msg = ch[cn].msg; msg; msg = next) {
    ...
    if (msg->type == NT_CHAR) {
      co = msg->dat1;
      if ((ch[co].flags & CF_PLAYER) && ticker - dat->lasttalk > TICKS * 5 &&
          char_dist(cn, co) < 12 && char_see_char(cn, co) &&
          (ppd = (struct nomad_ppd *)set_data(co, DRD_NOMAD_PPD,
                                              sizeof(struct nomad_ppd)))) {
    ...
    if (msg->type == NT_TEXT) {
      ...
      if ((ppd = (struct nomad_ppd *)set_data(co, DRD_NOMAD_PPD,
                                              sizeof(struct nomad_ppd)))) {
        switch (
            (res = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
          case 2:
            switch (dat->nr) {
              case 1:
      ...
      if ((ptr = strstr((char *)msg->dat2, "bet ")) && char_dist(cn, co) < 12 &&
          char_see_char(cn, co)) {
        val = atoi(ptr + 4);
        if (val) {
          switch (dat->nr) {
            case 1:
              if (ppd->nomad_state[dat->nr] >= 9)
                nomad_bet(cn, dat, co, val, ppd, dat->nr);
              else
                say(cn, "Sorry, I do not play with strangers.");
              break;
            case 2:
              if (ppd->tribe_member & TM_TRIBE1)
                nomad_bet(cn, dat, co, val, ppd, dat->nr);
              else
                say(cn, "Sorry, I do not play with strangers.");
              break;
    ...
    if (msg->type == NT_GIVE) {
      ...
      if ((in = ch[cn].citem)) {  // we still have it
        if ((ppd = (struct nomad_ppd *)set_data(co, DRD_NOMAD_PPD,
          ...
          switch (dat->nr) {
            case 1:
              if (!nomad_1_give(cn, co, in, ppd, dat->nr) &&
                  !give_char_item(co, in)) {
                destroy_item(in);
              }
              ch[cn].citem = 0;
              break;
            case 4:
              if (!nomad_4_give(cn, co, in, ppd, dat->nr) &&
                  !give_char_item(co, in)) {
                destroy_item(in);
              }
              ch[cn].citem = 0;
              break;
            case 5:
              if (!nomad_5_give(cn, co, in, ppd, dat->nr) &&
                  !give_char_item(co, in)) {
                destroy_item(in);
              }
              ch[cn].citem = 0;
    ...
    if (msg->type == NT_NPC) {
      if (msg->dat1 == NTID_DICE) {
        ...
        if (co == dat->play_with &&
            (ppd = (struct nomad_ppd *)set_data(co, DRD_NOMAD_PPD,
                                                sizeof(struct nomad_ppd))))
          nomad_roll(cn, dat, co, val, ppd, dat->nr);
      }
    }
  ...
  if (ticker - dat->lasttalk > TICKS * 10 &&
      secure_move_driver(cn, ch[cn].tmpx, ch[cn].tmpy, DX_DOWN, ret, lastact))
    return;
...
void madhermit_driver(int cn, int ret, int lastact) {
  ...
  // dat=set_data(cn,DRD_SIMPLEBADDYDRIVER,sizeof(struct
  // simple_baddy_driver_data));
  // if (!dat) return;  // oops...
