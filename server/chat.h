...
int tell_chat(int cnID, int coID, int staffmode, const char *format, ...)  __attribute__ ((format(printf, 4, 5)));
int server_chat(int channel, const char *text);
void npc_chat(int cn, int channel, const char *format, ...) __attribute__ ((format(printf, 3, 4)));
