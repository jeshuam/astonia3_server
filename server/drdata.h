...
void *set_data(int cn, int ID,
               int size);      // create buffer of size at "position" ID of cn
int del_data(int cn, int ID);  // remove data block ID from cn
void *get_data(int cn, int ID,
               int size);   // get the block ID from cn, return NULL on error
