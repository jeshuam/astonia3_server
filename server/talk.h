...
#define LOG_SYSTEM 0
#define LOG_TALK \
  1  // dat1=co, everyone in area gets it, blocked by
     // MF_SOUNDBLOCK|MF_SHOUTBLOCK
#define LOG_SHOUT \
  2  // dat1=co, everyone in area gets it, blocked by MF_SHOUTBLOCK
#define LOG_INFO \
  3  // dat1=co, visibility check determines whether the char gets the message
     // or not
